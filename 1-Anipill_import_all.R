...
T1raw <- read_csv ("./anipill_tablets/HibExp_1_T1.csv", skip = 7, col_names = TRUE)
T1raw1 <- read_csv ("./anipill_tablets/HibExp_1_T1.csv", skip = 9, col_names = FALSE)
...
T2raw <- read_csv ("./anipill_tablets/HibExp_1_T2.csv", skip = 7, col_names = TRUE, show_col_types = FALSE)
T2raw1 <- read_csv ("./anipill_tablets/HibExp_1_T2.csv", skip = 9, col_names = FALSE, show_col_types = FALSE)
...
T3raw <- read_csv ("./anipill_tablets/HibExp_1_T3.csv", skip = 6, col_names = TRUE, show_col_types = FALSE) #just to get the ap_ID ID
T3raw1 <- read_csv ("./anipill_tablets/HibExp_1_T3.csv", skip = 9, col_names = FALSE, show_col_types = FALSE)
...
#################################Tablet 4#################################
T4raw <- read_csv ("./anipill_tablets/HibExp_1_T4.csv", skip = 7, col_names = TRUE, show_col_types = FALSE)
T4raw1 <- read_csv ("./anipill_tablets/HibExp_1_T4.csv", skip = 9, col_names = FALSE, show_col_types = FALSE)
...
###################################Tablet 5##########################
T5raw <- read_csv ("./anipill_tablets/HibExp_1_T5.csv", skip = 7, col_names = TRUE, show_col_types = FALSE) #just to get the ap_ID ID
T5raw1 <- read_csv ("./anipill_tablets/HibExp_1_T5.csv", skip = 9, col_names = FALSE, show_col_types = FALSE)
...
Tempisbjorn <- read_csv("./env/Tempisolat.csv", na = "empty")
...
head(allcoreT)
summary(allcoreT)
allcoreT <- na.omit(allcoreT)

write.csv(allcoreT,"./anipill_tablets/allcoreT.csv")
